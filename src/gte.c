...
s32 BOUNDS(/*int44*/s64 value, u32 max_flag, u32 min_flag) {
...
s32 A1(/*int44*/s64 a) { return BOUNDS(a, (1u << 31) | (1u << 30), (1u << 31) | (1u << 27)); }
s32 A2(/*int44*/s64 a) { return BOUNDS(a, (1u << 31) | (1u << 29), (1u << 31) | (1u << 26)); }
s32 A3(/*int44*/s64 a) { m_mac3 = a; return BOUNDS(a, (1u << 31) | (1u << 28), (1u << 31) | (1u << 25)); }
s32 Lm_B1(s32 a, int lm) { return LIM(a, 0x7fff, -0x8000 * !lm, (1u << 31) | (1u << 24)); }
s32 Lm_B2(s32 a, int lm) { return LIM(a, 0x7fff, -0x8000 * !lm, (1u << 31) | (1u << 23)); }
s32 Lm_B3(s32 a, int lm) { return LIM(a, 0x7fff, -0x8000 * !lm, (1u << 22)); }
...
s32 Lm_C1(s32 a) { return LIM(a, 0x00ff, 0x0000, (1u << 21)); }
s32 Lm_C2(s32 a) { return LIM(a, 0x00ff, 0x0000, (1u << 20)); }
s32 Lm_C3(s32 a) { return LIM(a, 0x00ff, 0x0000, (1u << 19)); }
s32 Lm_D(s64 a, int sf) { return LIM(gte_shift(a, sf), 0xffff, 0x0000, (1u << 31) | (1u << 18)); }
