...
static void delayRead(u32 reg, u32 bpc) {
    u32 rold, rnew;
...
int psxTestLoadDelay(u32 reg, u32 tmp) {
...
void psxDelayTest(u32 reg, u32 bpc) {
    u32 *code;
    u32 tmp;
...
void psxDIV() {
    ...
    } else if (_i32(_rRs_) == (signed)0x80000000 && _i32(_rRt_) == (signed)0xFFFFFFFF) {
...
void PsxCpuClear(u32 Addr, u32 Size)
{
    (void)Addr;
    (void)Size;
}
